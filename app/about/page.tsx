          ...
          <Card>
            ...
            <CardContent>
              <p className="text-lg text-muted-foreground">
                To glorify God by making disciples of all nations through the proclamation of the
                Gospel, the teaching of God&apos;s Word, and the demonstration of Christ&apos;s
                love in our community and beyond.
              </p>
            </CardContent>
          </Card>
        </motion.div>
      ...
      <section className="mb-16">
        ...
        >
          <Card>
            ...
            <CardContent>
              <p className="text-lg text-muted-foreground">
                To be a church where every person experiences the transforming power of God&apos;s
                love, grows in their relationship with Christ, and is equipped to serve others with
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            { name: "Elder Mary Johnson", role: "Elder" },
            { name: "Deacon Robert Williams", role: "Deacon" },
          ].map((leader, index) => (
            <motion.div
              key={leader.name}
              initial={{ opacity: 0, y: 20 }}
